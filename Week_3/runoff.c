...
void tabulate(void)
{
    ...
    for( int i = 0; i < voter_count; i++)
    {
        //loop over all the preferences of each voter
        for (int j = 0; j < candidate_count; j++)
        {
           int preference = preferences[i][j];
           //if the prefered candidate is not eliminated, add to his votes
...
int find_min(void)
{
    //initialize to the highest possible number of votes
